...
<style>
    ...
    <div class="container px-5 py-5">
        <div class="row">
            ...
            <div class="card col-md-10 mx-auto">
              ...
              <form action="<?= base_url('/public/index.php/simpan_slip_gaji'); ?>" method="POST" class="row g-3">
  <div class="col-md-3">
  ...
  <div class="col-md-4">
      ...
      <input type="number" class="form-control form-control-sm" name="alpha" required>
  </div>
  <div class="col-md-4">
      <label for="exampleInputEmail1" class="form-label">Ijin</label>
      <input type="number" class="form-control form-control-sm" name="ijin" required>
  </div>
  <div class="col-md-4">
  ...
  <div class="col-md-4">
      ...
      <input type="number" class="form-control form-control-sm" name="potongan_alpha" required>
  </div>
  <div class="col-md-4">
      <label for="exampleInputEmail1" class="form-label">Potongan Ijin</label>
      <input type="number" class="form-control form-control-sm" name="potongan_ijin" required>
  </div>
  <div class="col-md-4">
